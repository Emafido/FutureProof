...
const LearningDashboard = () => {
  ...
  const Sidebar = () => (
    ...
    >
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
            {getInitials(userInfo.full_name)}
          </div>
          <div className="min-w-0">
            <p className="font-semibold text-gray-900 truncate">{userInfo.full_name}</p>
            <p className="text-sm text-gray-600 truncate">{userInfo.role}</p>
          </div>
        </div>
      </div>
    ...
    <div className="flex min-h-screen bg-gray-50 font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto w-full min-w-0">
        ...
        <main className="flex-1 overflow-x-hidden p-4 sm:p-6 lg:p-8">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-8">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">
                  Welcome back, {getFirstName(userInfo.full_name)}! 👋
                </h1>
                <p className="text-gray-600 text-base sm:text-lg">
                  Let's continue your journey to becoming a {userInfo.role}.
                </p>
              </div>
          ...
          {activeNav !== 'dashboard' && activeNav !== 'roadmap' && (
