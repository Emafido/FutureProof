...
const LoginForm = ({ handleLogin, handleChange, formData, loading }) => {
  return (
    <div className="p-8">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Welcome back</h2>
      {/* Form submission is wired to handleLogin */}
      <form className="space-y-5" onSubmit={handleLogin}>
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition duration-200 transform hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50"
        >
